                            ...
                            <div class="login-form-container">
                                <div class="login-register-form">
                                    <form action="LoginController" method="post">
                                        <input class="normalInput ${classErrUsername}" type="text" name="user-name"
                                               placeholder="Username" value="${txtUsername}"/>
                                        <p class="errText">${errUsername}</p>
                                        <input class="normalInput ${classErrPassword}" type="password"
                                               name="user-password" placeholder="Password" value="${txtPassword}"/>
